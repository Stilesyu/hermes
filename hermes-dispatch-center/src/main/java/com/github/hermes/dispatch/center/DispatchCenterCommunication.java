...
package com.github.hermes.dispatch.center;
...
import com.github.communication.context.ServerCommunicationContext;
...
import com.github.communication.netty.handler.RequestDecodeHandler;
 ...
 */
@Slf4j
public class DispatchCenterCommunication implements Communication {
     ...
     * @since 1.0
     */
    public DispatchCenterCommunication(ServerNettyConfig config) {
    ...
    public void load() throws InterruptedException {
        ...
        AbstractCommunicationContext context = ServerCommunicationContext.builder().type(AbstractCommunicationContext.Type.SERVER).bootstrap(bootstrap).build();
